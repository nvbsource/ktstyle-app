                  ...
                  >
                    <div className='relative'>
                      <TextArea
                        ...
                        autoSize={true}
                        className="border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-600 text-[20px] !leading-7 !min-h-[100px] !max-h-[600px] p-5"
