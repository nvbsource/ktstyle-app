...
const ProductFilter = ({ setLoading, setProducts, setIsCardView, isCardView }) => {
    ...
    return (
        <div className="flex flex-wrap justify-between mb-4 gap-4">
            <div className="flex gap-4 flex-wrap w-full sm:w-auto">
                ...
                {/* Category Filter */}
                <div className="flex flex-col w-full sm:w-48">
                    <label className="mb-2 text-sm font-medium text-gray-700">Chọn danh mục</label>
                    <Select
                ...
                {/* Price Filter */}
                <div className="flex flex-col w-full sm:w-72">
                    <label className="mb-2 text-sm font-medium text-gray-700">Lọc theo giá</label>
                    <Slider
                        range
                        min={0}
                        max={10000000}
